    ...
    useEffect(() => {
        if (generateStudyPlan['personalizedStudyPlan']) {
            ...
            const newData = {
                ...
                studyDuration: `${start && end ? `${start} - ${end}` : ''}`,
                studyTime: userProfile?.studyTime,
                studyDays: getShortDay(userProfile?.studyDays),
                totalTimeCommitment: convertToHoursAndMinutes(userProfile?.totalTimeCommitment),
    ...
    return (
        <>
                    ...
                    isLoading ?
                        ...
                        <div className="card bg-white text-black border border-[#00bcd4] shadow-md rounded-lg p-4 md:p-8 w-[95%] md:w-[80%] my-8">
                            ...
                            <div className="short-details card flex flex-col sm:flex-row text-center bg-white text-black border shadow-md rounded-lg py-4 my-4 sm:py-8 sm:my-8">
                                ...
                                <div className="border-b sm:border-b-0 sm:border-r border-gray-300 flex justify-center items-center py-2 sm:px-2 sm:py-0 grow">
                                    <div className="self-center mx-auto">
                                        <h2 className='text-base sm:text-xs md:text-sm lg:text-base font-semibold'>{data?.studyTime}</h2>
            ...
            >
                <div className="flex flex-col justify-center items-center">
                    <div>
                        <AuthIcon className='w-[225px] h-[175px] md:w-[300px] md:h-[200px]' />
                    </div>
                    <p className='text-lg text-center font-semibold mb-6'>Please sign in to add your study plan and<br /> start your learning journey!</p>
                    <Button
                        className='btn !border-[#00bcd4] !text-[rgb(0,188,212)] bg-[rgba(0,188,212,.1)] hover:!bg-[rgba(0,188,212,.2)] text-lg px-4 py-2 w-fit h-[35px]'
